  ...
  const workflowSteps: WorkflowStep[] = [
    {
      ...
      title: "Kataloğum",
      description:
        "Sanatçıları, ekstra hizmetleri, maliyet ve satış bedellerini yönet.",
    ...
    },
    {
      ...
      description:
        "Müşteri, yetkili kişi ve mekan kayıtlarını operasyon için hazırla.",
    ...
    },
    {
      ...
      description:
        "Katalogdan seçim yap, fiyatları düzenle ve paket teklif oluştur.",
    ...
    },
    {
      ...
      description:
        "Sanatçı şartlarını ve saha hazırlıklarını etkinlik dosyasından yönet.",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
      <header className="sticky top-0 z-10 border-b border-slate-200 bg-white/95 px-5 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          <button
            className="text-left"
            aria-label="VIA EVENTS Operasyon Merkezi"
          >
            <img
          ...
          <div className="mt-2 flex flex-col justify-between gap-4 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">
                Katalog, müşteri, teklif, anlaşma ve saha kontrol sürecini
                başlat.
              </p>
            </div>
          ...
          {workflowSteps.map((item) => {
            ...
            return (
              ...
              >
                ...
                <p
                  className={`mt-auto pt-5 text-sm font-black ${toneClass.action}`}
                >
                  {item.actionLabel} →
                </p>
              </button>
